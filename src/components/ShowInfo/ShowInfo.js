...
class ShowInfo extends Component {
  ...
  render() {
    const {
      show: { name, genres, image, premiered, rating, network, summary },
      casts,
      seasons,
      loading
    } = this.state
          ...
          <div className="center">
            ...
            {genres && (
              <div className="show-genre">
                <p>Genres</p>
                {genres.map(genre => (
                  <span key={genre} className="border">
                    {genre}
                  </span>
                ))}
              </div>
            ...
            {network && (
              <div className="show-network">
                <p>Network</p>
                <span className="border">{network.name}</span>
              </div>
            )}
          </div>
        </div>
